  ...
  return (
    <div>
      ...
      <div className={style.about_container}>
        ...
        and __________ (&quot;Company,&quot; “we,&quot; “us,&quot; or “our”),
        concerning your access to and use of the __________ website as well as
        ...
        IMMEDIATELY. Supplemental terms and conditions or documents that may be
        ...
        revised Terms of Use are posted. The information provided on the Site is
        ...
        all current or future use of the Site (or any portion thereof). 4. 
        <h2>MISCELLANEOUS</h2>PROHIBITED ACTIVITIES You may not access or use
        ...
        As a user of the Site, you agree not to:  Systematically retrieve data
        ...
        services or submit false reports of abuse or misconduct.  Use the Site
        in a manner inconsistent with any applicable laws or regulations. 
        Engage in unauthorized framing of or linking to the Site.  Upload or
        transmit (or attempt to upload or to transmit) viruses, Trojan horses,
        or other material, including excessive use of capital letters and
        ...
        “spyware” or “passive collection mechanisms” or “pcms”).  Interfere
        ...
        Site.  Except as may be the result of standard search engine or
        ...
        launching any unauthorized script or other software.  Use a buying
        agent or purchasing agent to make purchases on the Site.  Make any
        ...
        or under false pretenses.  Use the Site as part of any effort to
        ...
        Use.  Your Contributions are not false, inaccurate, or misleading. 
        ...
        Site in violation of the foregoing violates these Terms of Use and may
        ...
        WARNING, IN OUR SOLE DISCRETION. If we terminate or suspend your account
        ...
        Binding Arbitration Any dispute arising out of or in connection with
        ...
        of __________. Restrictions The Parties agree that any arbitration shall
        ...
        public or any other persons. Exceptions to Arbitration The Parties agree
        that the following Disputes are not subject to the above provisions
        concerning binding arbitration: (a) any Disputes seeking to enforce or
        ...
        PAID, IF ANY, BY YOU TO US OR __________. CERTAIN US STATE LAWS AND
