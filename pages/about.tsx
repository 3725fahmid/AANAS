  ...
  return (
    <div>
        ...
        <Container>
          <Card sx={{}}>
            ...
            <CardContent>
              ...
              >
                <h1>
                  বাংলাদেশ কারা বিভাগের ওয়েব পোর্টালে আপনাকে স্বাগতম। আজকের
                  বিশ্বে তথ্য প্রযুক্তির ব্যবহার দ্রুত ও কার্যকর যোগাযোগের দ্বার
                  উন্মোচন করেছে। এর ধারাবাহিকতায় বাংলাদেশের কারা ব্যবস্থাপনা
                  সম্পর্কে তথ্য প্রদানে কারা বিভাগের এই ওয়েবসাইটটি উল্লেখযোগ্য
                  ভূমিকা পালন করবে। জনসাধারণের জন্য প্রয়োজনীয় তথ্য পাওয়া এখন
                  অনেক সহজসাধ্য হবে। কারা ব্যবস্থাপনা সম্পর্কে সঠিক তথ্য সহজে
                  উপস্থাপন করার পাশাপাশি জনসাধারণ ও কারা অধিদপ্তরের মধ্যে এটি
                  সেতুবন্ধন হিসেবে কাজ করবে। ই-মেইলের মাধ্যমে জনগণ কর্তৃপক্ষের
                  সাথে যোগাযোগ স্থাপন এবং মতামত ও পরামর্শ দিতে সক্ষম হবেন।
                  তাছাড়া, কারা কর্মকর্তাদের কাছ থেকেও প্রয়োজনীয় ক্ষেত্রে পরামর্শ
                  চাওয়া যেতে পারে। আশা করা যায় যে, বিদ্যমান ওয়েবসাইটটি বাংলাদেশে
                  তথ্য প্রযুক্তির চর্চাকে আরো সমৃদ্ধ করবে। আরো প্রত্যাশা যে,
                  প্রয়োজনীয় তথ্য থেকে সংশ্লিষ্ট সকলে পূর্ণাঙ্গ সুবিধা পাবেন ও
                  উপকৃত হবেন। ফলশ্র“তিতে, জনসাধারণকে আরো কার্যকর সেবা প্রদান
                  করতে বাংলাদেশের কারাগারসমূহের সক্ষমতা বৃদ্ধি পাবে। বাংলাদেশ
                  কারা বিভাগ বন্দিদের নিরাপদ আটক নিশ্চিত করার মাধ্যমে জনগণকে
                  সার্বক্ষণিক সেবা প্রদান করে যাচ্ছে। আমাদের দায়িত্ব হচ্ছে
                  মানবিকতার সাথে বন্দিদের তত্ত্বাবধান করা এবং মুক্তির পর তাদেরকে
                  আইনের প্রতি শ্রদ্ধাশীল হয়ে উন্নত জীবন যাপন করতে অনুপ্রাণিত ও
                  সাহায্য করা।
                </h1>
                {/* <h2>AGREEMENT TO TERMS </h2>
              These Terms of Use constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity (“you”)
              and Company,&quot; “we,&quot; “us,&quot; or “our”), concerning
              your access to and use of the __________ website as well as any
              ...
              of each such change. Please ensure that you check the applicable
              ...
              or future use of the Site (or any portion thereof). 4. 
              <h2>MISCELLANEOUS</h2>PROHIBITED ACTIVITIES You may not access or
              ...
              Content contained therein.  Disparage, tarnish, or otherwise
              harm, in our opinion, us and/or the Site.  Use any information
              obtained from the Site in order to harass, abuse, or harm another
              person.  Make improper use of our support services or submit
              ...
              unauthorized framing of or linking to the Site.  Upload or
              ...
              Site.  Engage in any automated use of the system, such as using
              scripts to send comments or messages, or using any data mining,
              robots, or similar data gathering and extraction tools.  Delete
              ...
              restrict access to the Site, or any portion of the Site.  Copy or
              adapt the Site’s software, including but not limited to Flash,
              PHP, HTML, JavaScript, or other code.  Except as permitted by
              ...
              part of the Site.  Except as may be the result of standard search
              ...
              or other software.  Use a buying agent or purchasing agent to
              make purchases on the Site.  Make any unauthorized use of the
              ...
              under false pretenses.  Use the Site as part of any effort to
              ...
              party.  You are the creator and owner of or have the necessary
              ...
              these Terms of Use.  Your Contributions are not false,
              ...
              forms of solicitation.  Your Contributions are not obscene, lewd,
              lascivious, filthy, violent, harassing, libelous, slanderous, or
              otherwise objectionable (as determined by us).  Your
              Contributions do not ridicule, mock, disparage, intimidate, or
              abuse anyone.  Your Contributions are not used to harass or
              ...
              regulation, or rule.  Your Contributions do not violate the
              ...
              law or regulation. Any use of the Site in violation of the
              foregoing violates these Terms of Use and may result in, among
              ...
              WARNING, IN OUR SOLE DISCRETION. If we terminate or suspend your
              ...
              of __________. __________ and yourself irrevocably consent that
              the courts of __________ shall have exclusive jurisdiction to
              resolve any dispute which may arise in connection with these
              terms.
              <h2>DISPUTE RESOLUTION</h2>
              Binding Arbitration Any dispute arising out of or in connection
              ...
              clause. The number of arbitrators shall be __________. The seat,
              or legal place, of arbitration shall be __________. The language
              of the proceedings shall be __________. The governing law of the
              contract shall be the substantive law of __________. Restrictions
              ...
              agree to submit to the personal jurisdiction of that court. 13. 
              <h2>CORRECTIONS</h2>
              ...
              ANY, BY YOU TO US OR __________. CERTAIN US STATE LAWS AND
      ...
      <div className={style.Footer}>
        কারাগারসমূহের সক্ষমতা বৃদ্ধি পাবে। বাংলাদেশ কারা বিভাগ বন্দিদের নিরাপদ
        আটক নিশ্চিত করার মাধ্যমে জনগণকে সার্বক্ষণিক সেবা প্রদান করে যাচ্ছে।
        আমাদের দায়িত্ব হচ্ছে মানবিকতার সাথে বন্দিদের তত্ত্বাবধান করা এবং মুক্তির
        পর তাদেরকে আইনের প্রতি শ্রদ্ধাশীল হয়ে উন্নত জীবন যাপন করতে অনুপ্রাণিত ও
        সাহায্য করা
      </div>
    </div>
  );
